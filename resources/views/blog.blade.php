                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-md-7">
                      <div class="list__content">
                        <h5 class="list__title">{{ $Blogs->title }}
                        </h5>
                        <p class="list__overview__content">{{ $Blogs->sub_title }}</p>
                        ...
                        <div class="pricing__area">
                          <h5><i class="fas fa-calendar-day"></i> {{date('d M, Y', strtotime($Blogs->created_at))}}</h5>
                          <a href="{{ route('front.blogs.details',$Blogs->id) }}" class="btn-view">View Details</a>
                        </div>
                      </div>
                    </div>
                  </div>
